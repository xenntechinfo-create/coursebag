(() => {
    ...
    var t = {
            ...
            58303: (t, e, n) => {
                ...
                function s(t, e = Date.now()) {
                    const n = parseInt(`${t}`, 10);
                    if (!isNaN(n)) return 1e3 * n;
                    const s = Date.parse(`${t}`);
                    return isNaN(s) ? r : s - e
                }
                ...
                function i(t, {
                    ...
                    if (i)
                        for (const s of i.trim().split(",")) {
                            const [t, e, , , n] = s.split(":", 5), i = parseInt(t, 10), a = 1e3 * (isNaN(i) ? 60 : i);
                            if (e)
                                for (const s of e.split(";")) "metric_bucket" === s && n && !n.split(";").includes("custom") || (o[s] = r + a);
                            else o.all = r + a
                        } else a ? o.all = r + s(a, r) : 429 === e && (o.all = r + 6e4);
                    return o
                }
            },
            85932: (t, e, n) => {
                        ...
                        const e = t.root,
                            ...
                            r = t.iteratee || (t => {
                                ...
                                const r = /^[a-zA-Z]:\\/.test(t.filename) || t.filename.includes("\\") && !t.filename.includes("/"),
                                    o = /^\//.test(t.filename);
                                if (r || o) {
                                    const o = r ? t.filename.replace(/^[a-zA-Z]:/, "").replace(/\\/g, "/") : t.filename,
                                        i = e ? (0, s.V8)(e, o) : (0, s.P8)(o);
                                    t.filename = `${n}${i}`
                                }
                                return t
                            });
            ...
            94257: (t, e, n) => {
                ...
                function a() {
                    o = r.OW.onunhandledrejection, r.OW.onunhandledrejection = function(t) {
                        const e = t;
                        return (0, s.aj)("unhandledrejection", e), !(o && !o.__SENTRY_LOADER__) || o.apply(this, arguments)
            ...
            96822: (t, e, n) => {
                ...
                class d {
                    ...
                    captureMessage(t, e, n) {
                        const r = n && n.event_id ? n.event_id : (0, o.eJ)();
                ...
                const a = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "BroadcastChannel", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "SharedWorker", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
                    ...
                    u = (0, r._C)(((t = {}) => {
                        ...
                        return {
                            name: c,
                            setupOnce() {
                                e.setTimeout && (0, s.GS)(i.jf, "setTimeout", l), e.setInterval && (0, s.GS)(i.jf, "setInterval", l), e.requestAnimationFrame && (0, s.GS)(i.jf, "requestAnimationFrame", d), e.XMLHttpRequest && "XMLHttpRequest" in i.jf && (0, s.GS)(XMLHttpRequest.prototype, "send", p);
                ...
                function p(t) {
                    return function(...e) {
                        ...
                        return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((t => {
                            t in n && "function" == typeof n[t] && (0, s.GS)(n, t, (function(e) {
                                const n = {
                                        mechanism: {
                                            data: {
                                                function: t,
                                    ...
                                    r = (0, s.sp)(e);
                                return r && (n.mechanism.data.handler = (0, o.qQ)(r)), (0, i.LV)(e, n)
                            }))
                        })), t.apply(this, e)
                    }
                }
                ...
                function f(t) {
                    ...
                    n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && ((0, s.GS)(n, "addEventListener", (function(e) {
                        return function(n, r, s) {
                            ...
                            return e.apply(this, [n, (0, i.LV)(r, {
                                mechanism: {
                                    data: {
            ...
            136221: (t, e, n) => {
                ...
                function h(t, e, n, r) {
                    const s = m(t, e, n && n.syntheticException || void 0, r);
                    return (0, i.M6)(s), s.level = "error", n && n.event_id && (s.event_id = n.event_id), (0, a.XW)(s)
                }

                function g(t, e, n = "info", r, s) {
                    const o = _(t, e, r && r.syntheticException || void 0, s);
                    return o.level = n, r && r.event_id && (o.event_id = r.event_id), (0, a.XW)(o)
                }
                ...
                function m(t, e, n, a, c) {
                    ...
                    if ((0, s.BD)(e) || (0, s.W6)(e)) {
                        const r = e;
                        if ("stack" in e) u = l(t, e);
                        else {
                            const e = r.name || ((0, s.BD)(r) ? "DOMError" : "DOMException"),
                                o = r.message ? `${e}: ${r.message}` : e;
                            u = _(t, o, n, a), (0, i.gO)(u, o)
                        }
                        return "code" in r && (u.tags = { ...u.tags,
                            "DOMException.code": `${r.code}`
                        }), u
                    }
                    if ((0, s.bJ)(e)) return l(t, e);
                    if ((0, s.Qd)(e) || (0, s.xH)(e)) {
                        return u = function(t, e, n, i) {
                            const a = (0, r.KU)(),
                                c = a && a.getOptions().normalizeDepth,
                                u = {
                                    exception: {
                                        values: [{
                                            type: (0, s.xH)(e) ? e.constructor.name : i ? "UnhandledRejection" : "Error",
                                            value: v(e, {
                    ...
                    return u = _(t, e, n, a), (0, i.gO)(u, `${e}`, void 0), (0, i.M6)(u, {
                        synthetic: !0
                    }), u
                }
                ...
                function v(t, {
                    ...
                    if ((0, s.T2)(t)) return `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\``;
                    if ((0, s.xH)(t)) {
            ...
            164058: (t, e, n) => {
                ...
                function i(t, e = {}) {
                    ...
                    try {
                        ...
                        for (; n && i++ < r && (d = a(n, p), !("html" === d || i > 1 && c + s.length * l + d.length >= f));) s.push(d), c += d.length, n = n.parentNode;
                ...
                function a(t, e) {
                    ...
                    else if (n.id && o.push(`#${n.id}`), i = n.className, i && (0, r.Kg)(i))
                        for (a = i.split(/\s+/), l = 0; l < a.length; l++) o.push(`.${a[l]}`);
                    const p = ["aria-label", "type", "name", "title", "alt"];
                    for (l = 0; l < p.length; l++) c = p[l], u = n.getAttribute(c), u && o.push(`[${c}="${u}"]`);
                    return o.join("")
                }
            ...
            167415: (t, e, n) => {
                ...
                function a(t) {
                    const e = "console";
                    (0, i.s5)(e, t), (0, i.AS)(e, c)
                }

                function c() {
                    "console" in o.OW && r.Ow.forEach((function(t) {
                        t in o.OW.console && (0, s.GS)(o.OW.console, t, (function(e) {
                            return r.Z9[t] = e,
                                function(...e) {
                                    const n = {
                                        args: e,
                    ...
                    a = (0, r._C)(((t = {}) => {
                        ...
                        return {
                            ...
                            preprocessEvent(t, r, i) {
                                ...
                                (0, s.Q)(o.K8, a.stackParser, a.maxValueLength, n, e, t, r)
                            }
                        }
                    }));
                (0, r.F)(i, a)
                        ...
                        setupOnce() {
                            ...
                            try {
                                Function.prototype.toString = function(...t) {
                                    const e = (0, r.sp)(this),
                                        n = c.has((0, s.KU)()) && void 0 !== e ? e : this;
                                    return i.apply(n, t)
                                }
                            } catch (t) {}
                        },
            ...
            216634: (t, e, n) => {
                ...
                function a(t, e) {
                    !0 === e.debug && (s.T ? r.vF.enable() : (0, r.pq)((() => {
                        console.warn("[Sentry] Cannot initialize SDK with `debug` option using a non-debug bundle.")
                    })));
                    (0, o.o5)().update(e.initialScope);
                    const n = new t(e);
                    ! function(t) {
                        const e = (0, i.BF)().getStackTop();
            ...
            221874: (t, e, n) => {
                ...
                function p(t) {
                    (0, i.s5)("dom", t), (0, i.AS)("dom", f)
                }

                function f() {
                    if (!a.document) return;
                    const t = i.aj.bind(null, "dom"),
                        e = h(t, !0);
                ...
                function h(t, e = !1) {
                    return n => {
                        ...
                        (0, s.my)(n, "_sentryCaptured", !0), o && !o._sentryId && (0, s.my)(o, "_sentryId", (0, r.eJ)());
                        const i = "keypress" === n.type ? "input" : n.type;
                        if (! function(t) {
                                if (t.type !== l) return !1;
                                try {
                                    if (!t.target || t.target._sentryId !== d) return !1
                                } catch (e) {}
                                return !0
                            }(n)) {
                            t({
                                ...
                                name: i,
                                global: e
                            }), l = n.type, d = o ? o._sentryId : void 0
                        }
                        clearTimeout(u), u = a.setTimeout((() => {
                            d = void 0, l = void 0
                        }), c)
                    }
                }
            ...
            238033: (t, e, n) => {
                ...
                const f = parseFloat(p.M),
                    h = 100;
                class g {
                    constructor(t, e, n, r = f) {
                        let s, o;
                        this._version = r, e ? s = e : (s = new l.HG, s.setClient(t)), n ? o = n : (o = new l.HG, o.setClient(t)), this._stack = [{
                            scope: s
                        }], t && this.bindClient(t), this._isolationScope = o
                    }
                    isOlderThan(t) {
                    ...
                    withScope(t) {
                        ...
                        return (0, r.Qg)(n) ? n.then((t => (this.popScope(), t)), (t => {
                    ...
                    captureException(t, e) {
                        const n = this._lastEventId = e && e.event_id ? e.event_id : (0, s.eJ)(),
                    ...
                    captureMessage(t, e, n) {
                        const r = this._lastEventId = n && n.event_id ? n.event_id : (0, s.eJ)(),
                            o = new Error(t);
                    ...
                    startTransaction(t, e) {
                        ...
                        if (u.T && !n) {
                            this.getClient() ? i.vF.warn("Tracing extension 'startTransaction' has not been added. Call 'addTracingExtensions' before calling 'init':\nSentry.addTracingExtensions();\nSentry.init({...});\n") : i.vF.warn("Tracing extension 'startTransaction' is missing. You should 'init' the SDK before calling 'startTransaction'")
                        }
                        return n
                    }
                    traceHeaders() {
                    ...
                    startSession(t) {
                        ...
                        return u && "ok" === u.status && (0, d.qO)(u, {
                            status: "exited"
                        }), this.endSession(), e.setSession(i), i
                    }
                ...
                function S(t = m()) {
                    return b(t) && !x(t).isOlderThan(f) || w(t, new g), x(t)
                }
            ...
            276361: (t, e, n) => {
                function r(t, e = !1) {
                    return !(e || t && !t.startsWith("/") && !t.match(/^[A-Z]:/) && !t.startsWith(".") && !t.match(/^[a-zA-Z]([a-zA-Z0-9.\-+])*:\/\//)) && void 0 !== t && !t.includes("node_modules/")
                }
                    ...
                    return s => {
                        ...
                        if (o) {
                            ...
                            if (o[1]) {
                                ...
                                let t = s.lastIndexOf(".");
                                if ("." === s[t - 1] && t--, t > 0) {
                                    e = s.slice(0, t), n = s.slice(t + 1);
                                    const r = e.indexOf(".Module");
                                    r > 0 && (s = s.slice(r + 1), e = e.slice(0, r))
                                }
                                i = void 0
                            }
                            n && (i = e, a = n), "<anonymous>" === n && (a = void 0, s = void 0), void 0 === s && (a = a || "<anonymous>", s = i ? `${i}.${a}` : a);
                            let c = o[2] && o[2].startsWith("file://") ? o[2].slice(7) : o[2];
                            const u = "native" === o[5];
                            return c && c.match(/\/[A-Z]:/) && (c = c.slice(1)), c || !o[5] || u || (c = o[5]), {
                                filename: c,
                                module: t ? t(c) : void 0,
                                function: s,
                    ...
                    return e => {
                        ...
                        function p(t) {
                            r && (i && clearTimeout(i), i = setTimeout((async () => {
                                i = void 0;
                                const t = await r.pop();
                                t && (l("Attempting to send previously queued event"), h(t).catch((t => {
                                    l("Failed to retry sending", t)
                                })))
                            }), t), "number" != typeof i && i.unref && i.unref())
                        }
                        ...
                        async function h(t) {
                            try {
                                ...
                                let r = a;
                                if (e)
                                    if (e.headers && e.headers["retry-after"]) r = (0, o.FA)(e.headers["retry-after"]);
                                    else if ((e.statusCode || 0) >= 400) return e;
                                return p(r), d = c, e
                            } catch (i) {
                                if (r && await
                                    function(t, n, r) {
                                        return !(0, s.hP)(t, ["replay_event", "replay_recording", "client_report"]) && (!e.shouldStore || e.shouldStore(t, n, r))
                                    }(t, i, d)) return await r.insert(t), f(), l("Error sending. Event queued", i), {};
                                throw i
                            }
                        }
                        return e.flushAtStartup && f(), {
                            send: h,
                            flush: t => n.flush(t)
                        }
                    }
            ...
            294252: (t, e, n) => {
                ...
                function u(t) {
                    ...
                    })), s = Array.isArray(n) ? [...e, ...n] : "function" == typeof n ? (0, r.k9)(n(e)) : e;
                    const o = function(t) {
                            const e = {};
                            return t.forEach((t => {
                                const {
                ...
                function p(t, e, n) {
                    if (n[e.name]) o.T && s.vF.log(`Integration skipped because it was already installed: ${e.name}`);
                    else {
                        if (n[e.name] = e, -1 === c.indexOf(e.name) && (e.setupOnce(i.lb, a.BF), c.push(e.name)), e.setup && "function" == typeof e.setup && e.setup(t), t.on && "function" == typeof e.preprocessEvent) {
                        ...
                        o.T && s.vF.log(`Integration installed: ${e.name}`)
                    }
                }
            ...
            294870: (t, e, n) => {
                ...
                function c() {
                    if (a) return a;
                    if ((0, r.ap)(i.jf.fetch)) return a = i.jf.fetch.bind(i.jf);
                    const t = i.jf.document;
                    let e = i.jf.fetch;
                    if (t && "function" == typeof t.createElement) try {
                        ...
                        o.T && s.vF.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", n)
                    }
                    return a = e.bind(i.jf)
                }
            ...
            295928: (t, e, n) => {
                ...
                function d(t, e, n = (0, r.C)(t.bufferSize || l)) {
                    let d = {};
                    ...
                    function f(r) {
                        ...
                        if ((0, s.yH)(r, ((e, n) => {
                            ...
                            })), 0 === l.length) return (0, i.XW)();
                        const f = (0, s.h4)(r[0], l),
                            h = e => {
                                (0, s.yH)(f, ((n, r) => {
                                    const o = p(n, r);
                        ...
                        return n.add((() => e({
                            body: (0, s.bN)(f, t.textEncoder)
                        }).then((t => (void 0 !== t.statusCode && (t.statusCode < 200 || t.statusCode >= 300) && u.T && a.vF.warn(`Sentry responded with status code ${t.statusCode} to sent event.`), d = (0, o.wq)(d, t), t)), (t => {
                            throw h("network_error"), t
                        })))).then((t => t), (t => {
                            if (t instanceof c.U) return u.T && a.vF.error("Skipped sending event because buffer is full."), h("queue_overflow"), (0, i.XW)();
                            throw t
                        }))
                    }
                            ...
                            processEvent(e) {
                                ...
                                try {
                                    if (function(t, e) {
                                            ...
                                            return !1
                                        }(e, t)) return o.T && s.vF.warn("Event dropped due to being a duplicate of previously captured event."), null
                                } catch (n) {}
                                return t = e
                            }
                        }
            ...
            332471: (t, e, n) => {
                ...
                function m(t, e = 40) {
                    ...
                    for (let r = n.length; r > 0; r--) {
                        ...
                        if (!(t.length > e)) return r === n.length ? t : (0, a.xv)(t, e)
                    }
                    return ""
                }
                ...
                function v(t, e) {
                    if (function(t) {
                        ...
                        const r = {};
                        e.set(t, r);
                        for (const s of Object.keys(t)) void 0 !== t[s] && (r[s] = v(t[s], e));
                        return r
                    }
                    if (Array.isArray(t)) {
                        const n = e.get(t);
            ...
            343880: (t, e, n) => {
                ...
                function l() {
                    ...
                    (0, s.GS)(t, "open", (function(t) {
                        return function(...e) {
                            const n = Date.now(),
                                o = (0, r.Kg)(e[0]) ? e[0].toUpperCase() : void 0,
                                a = function(t) {
                            ...
                            if (!o || !a) return t.apply(this, e);
                            this[c] = {
                                method: o,
                                url: a,
                                request_headers: {}
                            }, "POST" === o && a.match(/sentry_key/) && (this.__sentry_own_request__ = !0);
                            const u = () => {
                                const t = this[c];
                            ...
                            return "onreadystatechange" in this && "function" == typeof this.onreadystatechange ? (0, s.GS)(this, "onreadystatechange", (function(t) {
                                ...
                                return function(...e) {
                                    const [n, s] = e, o = this[c];
                                    return o && (0, r.Kg)(n) && (0, r.Kg)(s) && (o.request_headers[n.toLowerCase()] = s), t.apply(this, e)
                                }
                            })), t.apply(this, e)
                        }
                        ...
                        return function(...e) {
                            ...
                            return (0, i.aj)("xhr", r), t.apply(this, e)
                        }
                    }))
                }
            },
            ...
            351940: (t, e, n) => {
                ...
                function c() {
                    ...
                    if (e && "function" == typeof e.createElement) try {
                        ...
                        r.T && s.vF.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", n)
                    }
                    return t
                }
            },
            364705: (t, e, n) => {
                ...
                function o(t, e) {
                    ...
                    return o > r - 5 && (o = r), o === r && (s = Math.max(o - 140, 0)), n = n.slice(s, o), s > 0 && (n = `'{snip} ${n}`), o < r && (n += " {snip}"), n
                }
                ...
                function i(t, e) {
                    ...
                    for (let o = 0; o < t.length; o++) {
                        const e = t[o];
                        try {
                            (0, r.L2)(e) ? n.push("[VueViewModel]"): n.push(String(e))
                        } catch (s) {
            ...
            427037: (t, e, n) => {
                ...
                const o = "HttpContext",
                    i = (0, r._C)((() => ({
                        ...
                        setupOnce() {},
                        preprocessEvent(t) {
                            if (!s.jf.navigator && !s.jf.location && !s.jf.document) return;
                            const e = t.request && t.request.url || s.jf.location && s.jf.location.href,
                                {
                                    referrer: n
                                } = s.jf.document || {},
                                {
            ...
            445315: (t, e, n) => {
                ...
                function f(t, e, n, f, g, m) {
                    ...
                    ! function(t, e) {
                        ...
                        "environment" in t || (t.environment = "environment" in e ? n : c.U);
                        void 0 === t.release && void 0 !== r && (t.release = r);
                        void 0 === t.dist && void 0 !== s && (t.dist = s);
                        t.message && (t.message = (0, o.xv)(t.message, i));
                    ...
                    }(y, S), void 0 === e.type && function(t, e) {
                        const n = i.OW._sentryDebugIds;
                        if (!n) return;
                        let r;
                        const s = h.get(e);
                        s ? r = s : (r = new Map, h.set(e, r));
                        const o = Object.keys(n).reduce(((t, s) => {
                            let o;
                            const i = r.get(s);
                            i ? o = i : (o = e(s), r.set(s, o));
                    ...
                    const b = g && g.getEventProcessors ? g.getEventProcessors() : [],
                        x = (0, l.m6)().getScopeData();
                    if (m) {
                        const t = m.getScopeData();
                        (0, d.Rg)(x, t)
                    }
                    if (E) {
                        const t = E.getScopeData();
                    ...
                    w.length && (n.attachments = w), (0, d.e2)(y, x);
                    const k = [...b, ...(0, u.lG)(), ...x.eventProcessors];
                    return (0, u.jB)(k, y, n).then((t => (t && function(t) {
                        const e = {};
                        try {
                            t.exception.values.forEach((t => {
                                t.stacktrace.frames.forEach((t => {
                        ...
                        t.contexts && t.contexts.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = (0, a.S8)(t.contexts.trace.data, e, n)));
                        t.spans && (r.spans = t.spans.map((t => {
                            const r = (0, p.et)(t).data;
                            return r && (t.data = (0, a.S8)(r, e, n)), t
                        })));
                        return r
                    }(t, _, v) : t)))
                }
                ...
                function g(t) {
                    if (t) return function(t) {
                        ...
                        return Object.keys(t).some((t => m.includes(t)))
                    }(t) ? {
                        captureContext: t
                    } : t
                }
                const m = ["user", "level", "extra", "contexts", "tags", "fingerprint", "requestSession", "propagationContext"]
            },
            453756: (t, e, n) => {
                n.d(e, {
                    k: () => u,
                ...
                function u(t) {
                    const e = (0, o.KU)();
                    if (!e) return {};
                    const n = c((0, a.et)(t).trace_id || "", e, (0, o.o5)()),
                        r = (0, i.z)(t);
                    if (!r) return n;
                    ...
                    S = (0, r._C)(((t = {}) => {
                        ...
                        return {
                            ...
                            setup(t) {
                                e.console && (0, o.P)(function(t) {
                                    return function(e) {
                                        ...
                                        const n = {
                                            ...
                                            level: (0, f.te)(e.level),
                                            message: (0, h.gt)(e.args, " ")
                                        };
                                        if ("assert" === e.level) {
                                            if (!1 !== e.args[0]) return;
                                            n.message = `Assertion failed: ${(0,h.gt)(e.args.slice(1)," ")||"console.assert"}`, n.data.arguments = e.args.slice(1)
                                        }(0, s.ZQ)(n, {
                                            input: e.args,
                                            level: e.level
                                        })
                                    }
                                }(t)), e.dom && (0, i.i)(function(t, e) {
                                    return function(n) {
                                        if ((0, s.KU)() !== t) return;
                                        ...
                                        a && a > v && (m.T && d.vF.warn(`\`dom.maxStringLength\` cannot exceed 1024, but a value of ${a} was configured. Sentry will use 1024 instead.`), a = v), "string" == typeof i && (i = [i]);
                                        try {
                                            const t = n.event,
                                                e = function(t) {
                                                    return !!t && !!t.target
                                ...
                                }(t, e.dom)), e.xhr && (0, a.Mn)(function(t) {
                                    return function(e) {
                                        if ((0, s.KU)() !== t) return;
                                        const {
                                            startTimestamp: n,
                                    ...
                                    return function(e) {
                                        ...
                                        const a = (0, g.Dl)(r);
                                        i && i.path || (i = o), o.protocol === a.protocol && o.host === a.host && (r = a.relative), o.protocol === i.protocol && o.host === i.host && (n = i.relative), (0, s.ZQ)({
                                            category: "navigation",
                                            data: {
                                                from: n,
                                                to: r
            ...
            478512: (t, e, n) => {
                ...
                function s(t = (0, r.eJ)(), e = (0, r.eJ)().substring(16), n) {
                    let s = "";
                    return void 0 !== n && (s = n ? "-1" : "-0"), `${t}-${e}${s}`
                }
            },
            500958: (t, e, n) => {
                n.d(e, {
                        ...
                        processEvent(e, n, a) {
                            ...
                            return function(t, e) {
                                if (e.ignoreInternal && function(t) {
                                        ...
                                        return !1
                                    }(t)) return i.T && r.vF.warn(`Event dropped due to being internal Sentry Error.\nEvent: ${(0,s.$X)(t)}`), !0;
                                if (function(t, e) {
                                        ...
                                        return function(t) {
                                            ...
                                            i.T && 0 === e.length && r.vF.error(`Could not extract message for event ${(0,s.$X)(t)}`);
                                            return e
                                        }(t).some((t => (0, o.Xr)(t, e)))
                                    }(t, e.ignoreErrors)) return i.T && r.vF.warn(`Event dropped due to being matched by \`ignoreErrors\` option.\nEvent: ${(0,s.$X)(t)}`), !0;
                                if (function(t, e) {
                                        if ("transaction" !== t.type || !e || !e.length) return !1;
                                        const n = t.transaction;
                                        return !!n && (0, o.Xr)(n, e)
                                    }(t, e.ignoreTransactions)) return i.T && r.vF.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.\nEvent: ${(0,s.$X)(t)}`), !0;
                                if (function(t, e) {
                                        if (!e || !e.length) return !1;
                                        const n = p(t);
                                        return !!n && (0, o.Xr)(n, e)
                                    }(t, e.denyUrls)) return i.T && r.vF.warn(`Event dropped due to being matched by \`denyUrls\` option.\nEvent: ${(0,s.$X)(t)}.\nUrl: ${p(t)}`), !0;
                                if (! function(t, e) {
                                        if (!e || !e.length) return !0;
                                        const n = p(t);
                                        return !n || (0, o.Xr)(n, e)
                                    }(t, e.allowUrls)) return i.T && r.vF.warn(`Event dropped due to not being matched by \`allowUrls\` option.\nEvent: ${(0,s.$X)(t)}.\nUrl: ${p(t)}`), !0;
                                return !1
                            }(e, d) ? null : e
                        }
                    })));
                ...
                function p(t) {
                    try {
                        ...
                        return i.T && r.vF.error(`Cannot extract url for event ${(0,s.$X)(t)}`), null
                    }
                }
            },
            512760: (t, e, n) => {
            ...
            515295: (t, e, n) => {
                ...
                function c(t, e) {
                    ...
                    ! function(t, e) {
                        ...
                        const l = (0, r.Ce)(s);
                        l && Object.keys(l).length && (t.tags = { ...l,
                            ...t.tags
                        });
                        const d = (0, r.Ce)(o);
                        ...
                        c && (t.transaction = c)
                            ...
                            if (n) {
                                t.sdkProcessingMetadata = {
                                    dynamicSamplingContext: (0, o.k)(e),
                                    ...t.sdkProcessingMetadata
                                };
                        ...
                        function(t, e) {
                            t.fingerprint = t.fingerprint ? (0, s.k9)(t.fingerprint) : [], e && (t.fingerprint = t.fingerprint.concat(e));
            ...
            560885: (t, e, n) => {
                ...
                class f extends r.V {
                    constructor(t) {
                        const e = d.jf.SENTRY_SDK_SOURCE || (0, o.e)();
                        (0, s.K)(t, "browser", ["browser"], e), super(t), t.sendClientReports && d.jf.document && d.jf.document.addEventListener("visibilitychange", (() => {
                            "hidden" === d.jf.document.visibilityState && this._flushOutcomes()
                        }))
                    }
                    eventFromException(t, e) {
                        return (0, l.u)(this._options.stackParser, t, e, this._options.attachStacktrace)
                    }
                    eventFromMessage(t, e = "info", n) {
                        return (0, l.qv)(this._options.stackParser, t, e, n, this._options.attachStacktrace)
                    }
                    captureUserFeedback(t) {
                        if (!this._isEnabled()) return void(u.T && i.vF.warn("SDK not enabled, will not capture user feedback."));
                        const e = (0, p.L)(t, {
                    ...
                    _flushOutcomes() {
                        ...
                        if (0 === t.length) return void(u.T && i.vF.log("No outcomes to send"));
                        if (!this._dsn) return void(u.T && i.vF.log("No dsn provided, will not send outcomes"));
                        u.T && i.vF.log("Sending outcomes:", t);
                        const e = (0, a.m)(t, this._options.tunnel && (0, c.SB)(this._dsn));
                        this._sendEnvelope(e)
                    }
                }
            },
            575132: (t, e, n) => {
                ...
                var r = n(500958),
                    ...
                    b = n(969983),
                    x = n(346833);
                const w = [(0, r.D)(), (0, s.Z)(), (0, S.G)(), (0, g.F)(), (0, _.L)(), (0, y.p)(), (0, m.s)(), (0, v.M)()];

                function k(t = {}) {
                    void 0 === t.defaultIntegrations && (t.defaultIntegrations = [...w]), void 0 === t.release && ("string" == typeof __SENTRY_RELEASE__ && (t.release = __SENTRY_RELEASE__), h.jf.SENTRY_RELEASE && h.jf.SENTRY_RELEASE.id && (t.release = h.jf.SENTRY_RELEASE.id)), void 0 === t.autoSessionTracking && (t.autoSessionTracking = !0), void 0 === t.sendClientReports && (t.sendClientReports = !0);
                    const e = { ...t,
                        stackParser: (0, c.vk)(t.stackParser || E.lG),
                        integrations: (0, o.mH)(t),
                        transport: t.transport || ((0, u.vm)() ? b._ : x.u)
                    };
                    (0, i.J)(p.y, e), t.autoSessionTracking && function() {
                        if (void 0 === h.jf.document) return void(f.T && l.vF.warn("Session tracking in non-browser environment with @sentry/browser is not supported."));
                        (0, a.J0)({
                            ignoreDuration: !0
                        }), (0, a.J5)(), (0, d._)((({
                            from: t,
            ...
            640686: (t, e, n) => {
                ...
                function a(t, e = {}) {
                    ...
                    return n || `${function(t){return`${i(t)}${t.projectId}/envelope/`}(t)}?${function(t,e){return(0,r.u4)({sentry_key:t.publicKey,sentry_version:o,...e&&{sentry_client:`${e.name}/${e.version}`}})}(t,s)}`
                }
            ...
            653214: (t, e, n) => {
                ...
                function c() {
                    (0, s.m7)() && (0, r.GS)(o.OW, "fetch", (function(t) {
                        return function(...e) {
                            const {
                                method: n,
                                url: r
                            ...
                            return (0, i.aj)("fetch", { ...s
                            }), t.apply(o.OW, e).then((t => {
                                const e = { ...s,
                                    endTimestamp: Date.now(),
                                    response: t
                                };
                                return (0, i.aj)("fetch", e), t
                            }), (t => {
                                const e = { ...s,
                                    endTimestamp: Date.now(),
                                    error: t
                                };
                                throw (0, i.aj)("fetch", e), t
                            }))
                        }
                    }))
                }
            ...
            653545: (t, e, n) => {
                ...
                function l(t, e = {}, n) {
                    ...
                    const s = function() {
                        ...
                        try {
                            ...
                            throw c++, setTimeout((() => {
                                ...
                                t.addEventProcessor((t => (e.mechanism && ((0, i.gO)(t, void 0, void 0), (0, i.M6)(t, e.mechanism)), t.extra = { ...t.extra,
                                    arguments: s
                                }, t))), (0, r.Cp)(o)
                            })), o
                        }
                    ...
                    } catch (u) {}(0, o.pO)(s, t), (0, o.my)(t, "__sentry_wrapped__", s);
                    try {
            ...
            663676: (t, e, n) => {
                ...
                function i(t) {
                    if (!(0, r.Kg)(t) && !Array.isArray(t)) return;
                    let e = {};
            ...
            692929: (t, e, n) => {
                ...
                function o(t, e, n = 250, o, a, c, u) {
                    ...
                    var d, p;
                    l && (c.exception.values = (d = i(t, e, a, u.originalException, o, c.exception.values, l, 0), p = n, d.map((t => (t.value && (t.value = (0, s.xv)(t.value, p)), t)))))
                }

                function i(t, e, n, s, o, u, l, d) {
                    ...
                    if ((0, r.tH)(s[o], Error)) {
                        ...
                        const r = t(e, s[o]),
                            u = p.length;
                        c(r, o, u, d), p = i(t, e, n, s[o], o, [r, ...p], r, u)
                    }
                    return Array.isArray(s.errors) && s.errors.forEach(((s, u) => {
                        if ((0, r.tH)(s, Error)) {
                            ...
                            const r = t(e, s),
                                f = p.length;
                            c(r, `errors[${u}]`, f, d), p = i(t, e, n, s, o, [r, ...p], r, f)
                        }
                    })), p
                }
            ...
            711517: (t, e, n) => {
                ...
                var r = n(538080),
                    s = (n(185732), n(737741), n(671164), n(147433)),
                    o = n(95783),
                    i = n(907964),
                    a = n(238033),
                    c = n(274386),
                ...
                function l(t, e) {
                    return (0, a.BF)().captureException(t, (0, u.li)(e))
                }
                ...
                function d(t, e) {
                    ...
                    return (0, a.BF)().captureMessage(t, n, r)
                }

                function p(t, e) {
                    return (0, a.BF)().captureEvent(t, e)
                }

                function f(t) {
                    (0, a.BF)().configureScope(t)
                }

                function h(t, e) {
                    (0, a.BF)().addBreadcrumb(t, e)
                }
                ...
                async function v(t) {
                    const e = y();
                    return e ? e.flush(t) : (i.T && r.vF.warn("Cannot flush events. No client defined."), Promise.resolve(!1))
                }

                function y() {
                    return (0, a.BF)().getClient()
                }

                function S() {
                    return (0, a.BF)().getScope()
                }
                ...
                function E(t) {
                    const e = y(),
                        ...
                        p = n.getSession();
                    return p && "ok" === p.status && (0, c.qO)(p, {
                        status: "exited"
                    }), b(), n.setSession(d), r.setSession(d), d
                }
                ...
                function b() {
                    ...
                    n && (0, c.Vu)(n), x(), t.setSession(), e.setSession()
                }
            ...
            768598: (t, e, n) => {
                                ...
                                e.onerror && (! function(t) {
                                    (0, o.L)((e => {
                                        ...
                                        const {
                                            ...
                                            return g(u, e, n, r)
                                        }(o, a, c, u) : g((0, d.H7)(n, l || o, void 0, r, !1), a, c, u);
                                        f.level = "error", (0, s.r)(f, {
                                            originalException: l,
                                            mechanism: {
                                                handled: !1,
                                                type: "onerror"
                                    ...
                                    (0, a.r)((e => {
                                        ...
                                        const o = function(t) {
                                            ...
                                            } : (0, d.H7)(n, o, void 0, r, !0);
                                        a.level = "error", (0, s.r)(a, {
                                            originalException: o,
                                            mechanism: {
                                                handled: !1,
                ...
                function m(t) {
                    l.T && u.vF.log(`Global Handler attached: ${t}`)
                }
            ...
            829387: (t, e, n) => {
                ...
                function c(t, e) {
                    ...
                    let c = [];
                    for (let i = o; i < n.length; i++) c.push("..");
            ...
            865604: (t, e, n) => {
                ...
                function a(t) {
                    ...
                    return {
                        insert: async e => {
                            try {
                                const r = await (0, s.bN)(e, t.textEncoder);
                                await
                                function(t, e, n) {
                                    return t((t => i(t).then((r => {
                                        if (!(r.length >= n)) return t.put(e, Math.max(...r, 0) + 1), o(t.transaction)
                                    }))))
                        ...
                        pop: async () => {
                            try {
                                const e = await
                                function(t) {
                                    return t((t => i(t).then((e => {
                                        if (0 !== e.length) return o(t.get(e[0])).then((n => (t.delete(e[0]), o(t.transaction).then((() => n)))))
                                    }))))
                                }(n());
                                if (e) return (0, s.mE)(e, t.textEncoder || new TextEncoder, t.textDecoder || new TextDecoder)
                            } catch (e) {}
                        }
                    }
                }
            ...
            868849: (t, e, n) => {
                ...
                function u(t, e, a = 1 / 0, c = 1 / 0, l = (0, s.s)()) {
                    const [d, p] = l;
                    ...
                    const h = "number" == typeof e.__sentry_override_normalization_depth__ ? e.__sentry_override_normalization_depth__ : a;
                    if (0 === h) return f.replace("object ", "");
                    if (d(e)) return "[Circular ~]";
                    const g = e;
                    if (g && "function" == typeof g.toJSON) try {
                        return u("", g.toJSON(), h - 1, c, l)
                    } catch (y) {}
            ...
            889762: (t, e, n) => {
                ...
                class S {
                    ...
                    captureException(t, e, n) {
                        if ((0, o.GR)(t)) return void(d.T && s.vF.log(y));
                        let r = e && e.event_id;
                    ...
                    captureMessage(t, e, n, r) {
                        let s = n && n.event_id;
                        const o = (0, i.NF)(t) ? t : String(t),
                            a = (0, i.sO)(t) ? this.eventFromMessage(o, e, n) : this.eventFromException(t, n);
                        return this._process(a.then((t => this._captureEvent(t, n, r))).then((t => {
                            s = t
                        }))), s
                    }
                    captureEvent(t, e, n) {
                        if (e && e.originalException && (0, o.GR)(e.originalException)) return void(d.T && s.vF.log(y));
                        let r = e && e.event_id;
                    ...
                    captureSession(t) {
                        "string" != typeof t.release ? d.T && s.vF.warn("Discarded session because of missing or non-string release") : (this.sendSession(t), (0, m.qO)(t, {
                            init: !1
                        }))
                    }
                    getDsn() {
                    ...
                    addIntegration(t) {
                        ...
                        (0, h.qm)(this, t, this._integrations), e || (0, h.lc)(this, [t])
                    }
                    sendEvent(t, e = {}) {
                        this.emit("beforeSendEvent", t, e);
                        let n = (0, p.V)(t, this._dsn, this._options._metadata, this._options.tunnel);
                        for (const s of e.attachments || []) n = (0, c.W3)(n, (0, c.bm)(s, this._options.transportOptions && this._options.transportOptions.textEncoder));
                        const r = this._sendEnvelope(n);
                        r && r.then((e => this.emit("afterSendEvent", t, e)), null)
                    }
                    sendSession(t) {
                        const e = (0, p.L)(t, this._dsn, this._options._metadata, this._options.tunnel);
                        this._sendEnvelope(e)
                    }
                    recordDroppedEvent(t, e, n) {
                        if (this._options.sendClientReports) {
                            const n = `${t}:${e}`;
                            d.T && s.vF.log(`Adding outcome: "${n}"`), this._outcomes[n] = this._outcomes[n] + 1 || 1
                        }
                    }
                    captureAggregateMetrics(t) {
                        d.T && s.vF.log(`Flushing aggregated metrics, number of metrics: ${t.length}`);
                        const e = (0, g.Z)(t, this._dsn, this._options._metadata, this._options.tunnel);
                        this._sendEnvelope(e)
                    }
                    on(t, e) {
                    ...
                    _setupIntegrations() {
                        ...
                        this._integrations = (0, h.P$)(this, t), (0, h.lc)(this, t), this._integrationsInitialized = !0
                    }
                    ...
                    _prepareEvent(t, e, n, r = (0, f.rm)()) {
                        const s = this.getOptions(),
                            o = Object.keys(this._integrations);
                        return !e.integrations && o.length > 0 && (e.integrations = o), this.emit("preprocessEvent", t, e), (0, v.mG)(s, t, e, n, this, r).then((t => {
                            if (null === t) return t;
                    ...
                    _processEvent(t, e, n) {
                        ...
                        return this._prepareEvent(t, e, n, f).then((n => {
                            ...
                            const s = function(t, e, n) {
                                ...
                                if (E(e) && r) return r(e, n);
                                if (b(e) && s) return s(e, n);
                                return e
                            }(r, n, e);
                            return function(t, e) {
                                const n = `${e} must return \`null\` or a valid event.`;
                                if ((0, i.Qg)(t)) return t.then((t => {
                                    if (!(0, i.Qd)(t) && null !== t) throw new u.U(n);
                                    return t
                                }), (t => {
                            ...
                            if (null === r) throw this.recordDroppedEvent("before_send", p, t), new u.U(`${d} returned \`null\`, will not send event.`, "log");
                ...
                function l(t, e, n, r = 0) {
                    return new s.T2(((s, c) => {
                        ...
                        if (null === e || "function" != typeof u) s(e);
                            ...
                            a.T && u.id && null === d && o.vF.log(`Event processor "${u.id}" dropped event`), (0, i.Qg)(d) ? d.then((e => l(t, e, n, r + 1).then(s))).then(null, c) : l(t, d, n, r + 1).then(s).then(null, c)
                        }
                    }))
                }
            },
                    ...
                    d = [
                        ...
                        [50, t => {
                            ...
                            if (e) {
                                ...
                                let t = e[3],
                                    n = e[1] || s;
                                return [n, t] = f(n, t), o(t, n, e[4] ? +e[4] : void 0, e[5] ? +e[5] : void 0)
                            }
                        }],
                        [40, t => {
                            const e = l.exec(t);
            ...
            971457: (t, e, n) => {
                ...
                function a() {
                    o = r.OW.onerror, r.OW.onerror = function(t, e, n, r, i) {
                        const a = {
                            column: r,
                            error: i,
                            line: n,
                        ...
                        return (0, s.aj)("error", a), !(!o || o.__SENTRY_LOADER__) && o.apply(this, arguments)
                            ...
                            processEvent: (t, r) => function(t, e = {}, n, r) {
                                ...
                                const u = e.originalException.name || e.originalException.constructor.name,
                                    l = function(t, e) {
                                        try {
                                            ...
                                            c.T && a.vF.error("Unable to extract extra data from the Error object:", n)
                                        }
                                        return null
                                ...
                                if (l) {
                                    const e = { ...t.contexts
                                        ...
                                        r = (0, o.S8)(l, n);
                                    return (0, s.Qd)(r) && ((0, i.my)(r, "__sentry_skip_normalization__", !0), e[u] = r), { ...t,
                                        contexts: e
                                    }
                                }
                                return t
    ...
    !self.Sentry && self.__sentry_config__ ? ((0, r.Ts)(self.__sentry_config__), (0, s.NA)("initLocation", "sentry_chunk")) : self.Sentry && self.__sentry_config__ ? Math.random() < .001 && self.Sentry.captureMessage("Legacy sentry installed") : self.Sentry && !self.__sentry_config__ && Math.random() < .001 && self.Sentry.captureMessage("Legacy sentry installed but new Sentry not configured"), self.Sentry || (self.Sentry = {
        ...
        init: r.Ts,
        onLoad: r.kF,
        rewriteFramesIntegration: i.D,
        setTag: s.NA,
        setExtra: s.l7,
        withScope: s.v4,
        flush: s.bX,
        dedupeIntegration: a.sn,
        extraErrorDataIntegration: c.X,
        makeBrowserOfflineTransport: u.z9,
